function compileCTest()
    ...
    [x_est, h_est, x_interf_est, h_interf_est] = blind_derendering(g, source_support_size, source, mat);
    figure;
...
function [x_est, h_est, x_interf_est, h_interf_est] = blind_derendering(d_full, tau, source, mat_interf)
    T = length(d_full(:, 1, 1));
    ...
    [s_est_full, g_est] = DerenderingStandardMatrixMoveCam(d_full, s_est_full, g_est, T, nmove, nsource, tau, 1e-8);
