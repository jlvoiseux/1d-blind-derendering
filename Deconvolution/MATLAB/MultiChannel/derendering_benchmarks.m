...
parfor i=1:10
    [errx_obs_size_move(i), errh_obs_size_move(i)] = DerenderingWrapper(40, round(obs_size_move_vec(i)), 16, 4, prop, tol, 1, 0.01);
...
parfor i=1:10
    [errx_obs_size_source(i), errh_obs_size_source(i)] = DerenderingWrapper(40, 16, round(obs_size_source_vec(i)), 4, prop, tol, 1, 0.01);
...
parfor i=1:10
    [errx_source_support_size(i), errh_source_support_size(i)] = DerenderingWrapper(40, 16, 16, round(source_support_size_vec(i)), prop, tol, 1, 0.01);
...
parfor i=1:10
    [errx_alpha(i), errh_alpha(i)] = DerenderingWrapper(40, 16, 16, 4, prop, tol, alpha_vec(i), 0.01);
...
parfor i=1:10
    [errx_beta(i), errh_beta(i)] = DerenderingWrapper(40, 16, 16, 4, prop, tol, 1, beta_vec(i));
